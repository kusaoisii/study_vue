...
難しいので、ただ文法をマスターしたい人はCDNを<script>で持ってくる環境をお勧めします。環境構築は必要ないので楽です。[こんな感じ](https://jsfiddle.net/kusaoisii/f3x4u5L0/4/)             

ただ,vue.jsの本命的なコンポーネントファイル`.vue`はVue-cliを導入しないといけないので、コンポーネントを学んだあと`.vue`ファイルを触れたくなった時,`vue-cli`の導入してもいいと思います。

今回、僕が使った参考書の紹介もしときます。    
図もそこそこあり、優しい文章で書かれてるので進めやすいと思います。       
あと、サイトのコードが載ってるので実行しやすいです。   

[参考書](https://www.amazon.co.jp/%E5%9F%BA%E7%A4%8E%E3%81%8B%E3%82%89%E5%AD%A6%E3%81%B6-Vue-js-mio/dp/4863542453)
[コードが載ってるサイト](https://cr-vue.mio3io.com/)
